...
The `source env/bin/activate` line can omitted if the virtual environment has already been activated. The ```<plot_file>``` is be any of the Python files provided in the [doc/plots/SCAN2000](plots/SCAN2000) or [doc/plots/SCAN2000-20](plots/SCAN2000-20) subdirectories, for example
```bash
